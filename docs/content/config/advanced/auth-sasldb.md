---
title: 'Advanced | SASLDB Authentication'
---
...
- `sasldb` plugin for SMTP authentication.
...
should contains a list of usernames that will be added to the sasldb file and as email accounts

### `SMTP_PASSWORDS`

should contains a list of passwords corresponding to the here under usernames.

examples:
SMTP_USERNAMES="username1 usename2 username3"
SMTP_PASSWORDS="passwordA passwordB passwordC"

username1 will be authenticated with passwordA
